...
def radialLineOfSight(inputObserverFeatures,
    ...
    try:
        ...
        desc = arcpy.Describe(bufferSurfaceSR)
        ...
        clipSurface = arcpy.Clip_management(inputSurface, Extent, clipSurface)
        
        saViewshed = sa.Viewshed2(clipSurface, observersSurfaceSR, "", "OBSERVERS", "",obsRelationshipTable)
        
        saViewshed = sa.Visibility(clipSurface, observersSurfaceSR, "", "OBSERVERS", "ZERO", "1", "CURVED_EARTH", "0.13")
