...
------------------------------------------------------------------------------
 ...
 ==================================================
 description:
 Finds the highest point(s) on an elevation surface within a
 user defined area. Uses maximum value statistic method.
 ==================================================
 history:
...
outputPointFeature = arcpy.GetParameterAsText(2) #2 - Output Highest Point Features
