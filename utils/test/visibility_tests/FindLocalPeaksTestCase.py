...
class FindLocalPeaksTestCase(unittest.TestCase):
    ...
    def test_find_local_peaks(self):
        ...
        try:
            arcpy.FindLocalPeaks_military(self.inputArea, self.inputSurface, self.outputPoints, 10)
        except:
    ...
    def test_find_local_peaks_no_input_area(self):
        ...
        try : 
           arcpy.FindLocalPeaks_military(noInputArea, self.inputSurface, self.outputPoints, 10)
